...
class SettingsScene : public GuiScene
{
	...
	Label& universe_header = gui.add<Label>("Universe Generation", UNIVERSE_START_X, COLUMN_Y, 12);
	...
	Label& start_size_label = gui.add<Label>("Universe starting size", UNIVERSE_START_X + LABEL_OFFSET, 320, 12);
	Label& num_planets_label = gui.add<Label>("Num planets", UNIVERSE_START_X + LABEL_OFFSET, 420, 12);
	Label& num_systems_label = gui.add<Label>("Num systems", UNIVERSE_START_X + LABEL_OFFSET, 520, 12);
	...
	Label& physics_header = gui.add<Label>("Physics", PHYSICS_START_X, COLUMN_Y, 12);
	TextBox& grav_const_input = gui.add<TextBox>("0.75", PHYSICS_START_X, COLUMN_Y + 100, TEXTBOX_WIDTH);

	Label& grav_const_label = gui.add<Label>("Grav const", PHYSICS_START_X + LABEL_OFFSET, 320, 12);
