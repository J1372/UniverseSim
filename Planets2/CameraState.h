...
public:
	...
	bool in_view(const Body& body) const { return camera.in_view(body); }
	bool in_view(Rectangle rect) const { return camera.in_view(rect); }
	Rectangle get_view() const { return camera.get_view(); }
